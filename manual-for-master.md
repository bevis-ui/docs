...
Убидиться можно на двух тестовых проектах.
...
И самая главная причина: конечно же мы любим бивис, потому что сами его и придумали ;)

PS. А ещё можно склонировать заготовку для создания бивис-проекта [BEViS Stub](http://github.com/bevis-ui/bevis-blog) и
создать свой сайт. Успехов!
