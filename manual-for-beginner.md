...
Хотите разрабатывать полноценные большие сайты и не изучать серверные языки программирования?

Тогда этот учебник для вас :)

Если вы хотя бы немного в курсе, что такое `HTML`, `CSS`, `Javascript`, то суть нашей придумки вы ухватите
