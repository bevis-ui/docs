...
## Что это?
`BEViS` - это `javascript` фреймворк для создания полноценных веб-сайтов. Это означает, что вам не нужно
знать ни одного серверного языка программирования, достаточно лишь небольших знаний о `HTML`, `CSS`, `Javascript`.
