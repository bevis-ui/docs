...
другого класса с помощью _публичных_ методов. Если вдруг вы отрефакторите какой-то класс и убьёте публичный 
метод (или даже поменяете местами ожидаемые параметры), скорее всего ваша программа сломается.
