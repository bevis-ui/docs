...
Но прямо сейчас читать необязательно. Главное вы уже поняли — оператор `new` нужен для того, чтобы создать инстанс 
какого-то класса, — экземпляр, конкретный объект. Что происходит под капотом этого оператора, прямо сейчас 
совершенно не важно знать. Важно понять одно - для создания инстансов класса в языке `Javascript` всё есть.
