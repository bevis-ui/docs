...
Я смогу ответить на это недовольство, но ниже. Чтобы понять, чтобы влюбиться в ООП на Javascript нужно узнать ещё немного. Совсем немного. А именно - как создавать методы класса. То есть, говоря про машину, как программировать умения автомобиля. Читаем, учимся?


Кстати, почему же я выше сказал, что не существует _красивого_ способа описывать свои собственные классы в `Javascript`? Смотришь на функцию-конструктор и всё нравится - ладненькая такая функция, аккуратненькая, понятная. Что не так?

### Методы класса. Prototype

Дальше про создание методов через прототипы.
