...
Внутри этой функции (её ещё называют `конструктором класса`) мы можем объявить все свойства будущих объектов (их ещё 
называют `инстансами класса`), которые мы будем создавать оператором `new`. Свойства объявляются с помощью полей вида 
`this.something`.
...
функции-конструкторе, а в отдельных методах, которые сохраняем в специальном и непонятном поле `prototype`. То есть,
 ...
 понимания, её можно изучить сильно позже, или не изучать вообще. 
