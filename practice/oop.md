...
Мол, автомобиль - это `Класс объектов`. Если выражаться привычными нам словами, это `Вид объектов`, что ли. Или `Тип 
объектов`, если так понятнее.

Как это понять? 

Выйдем на улицу, оглядимся. Машины стоят припаркованные, мест на парковке совсем не осталось. А что 
поделаешь - утро, самый разгар; люди по тротуарам спешат, на работу всем надо; а вверх с вами посмотрим — там самолёт 
белым хвостом выхлопных газов разрезает небо надвое. Обычная картина.
...
А `Объект` — это, мол, конкретная машина, созданная на конкретном автомобильном заводе. Машина имеет все характерные 
признаки класса автомобиль (4 колеса, двигатель, руль...), но это уже не абстрактный класс (не абстрактный тип 
автомобиля), а вполне себе реальная штуковина, которую можно пощупать, в неё можно сесть, завести и поехать на море.

То есть, `Класс`, — объясняли в учебнике, - это `сущность абстрактная, шаблонная`. Такая же, как лекало, образец. Она 
лишь описывает совйства и умения, которыми будет обладать конкретный объект (ещё его называют экземпляр класса), 
когда его создадут по этим правилам. То есть, `Объект - это уже конкретная реализация этого класса`.
