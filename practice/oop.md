...
Спасибо им. Но что такое `new String()`? Посмотрим на два фрагмента кода и снавним комментарии к ним: 
...
```javascript
// Создаём объект `name` строкового класса (то есть, класса `String`) и присваиваем объекту значение
var name = new String("BEViS");
```
...
Повторим, когда мы пишем `var name = 'BEViS'`, на самом деле мы создаём не строковую переменную, а экземпляр класса 
`Строка`. Или, другими словами, объект класса `String`.
