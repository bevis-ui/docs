...
план
* Рассказть об устройстве модели, публичные и приватные методы, почему именно такие методы, зачем. 
...
* дать ссылку на mvc-application
* сделать mvc-bevis-stub и дать на него ссылки.
