...
мысль перечитать [раздел про генерацию блока на клиенте](yblock.md)?_
...
_Знаете ведь? Если не очень, а перечитайте [раздел про генерацию блока на клиенте](yblock.md)_
