...
сохраняют данные в куке и читают их из куки, на следующем занятии мы перепишем их, и они будут работаь не с кукой, а 
с реальным бекендом. 


план
* закончить статью: подбить итоги, что мы сделали: контроллеры приложения и страницы, вью, модель. Работают через 
обменивание событий. Командир только один - все нити дердит у себя, только раздаёт указания и слушает отчёты.
* закончить статью: рассказать, что сделаем в следующей статье
