...
такую создав, конечно. То есть, настент день, когда мы не только контроллеры разделим между страницами, а ещё и 
...
Проверем. У меня успех наполовину :)
...
Это было долго и муторно. Не печальтесь, делать всё это из проекта в проект не надо, есть [готовая болванка]() (ЕЩЁ 
