...
*Менеджер - это Контроллер (`Controller`)*
  ...
  * Как Менеджер организует работу в магазине, так Контроллер организует работу `web`-приложения. Именно в этом файле 
  начинается работа приложения. Имено здесь мы управляем, из каких Моделей нужно запросить данные. Именно здесь мы 
  полученные данные перенаправляем в Представления. Именно здесь мы получаем сообщения от View, что 
