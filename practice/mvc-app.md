...
`client/controllers`, `client/views`, `client/models` — всё свалено в папкe `blocks`. Но даже так можно без труда 
увидеть там и контроллер и модели и вьюхи. И если на этом занятии мы сохраняли данные в куку, то в `bevis-todo` 
