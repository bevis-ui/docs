...
1. Во-первых, мы хотим, чтобы приложение отвечает по адресу `localhost:8080`. Не будем больше пользоваться 
...
Теперь, когда задача ясна, напишем алгоритм работы Контроллера.
