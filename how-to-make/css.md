...
Хранить все `view` и миксины в одном файле неудобно. Можно. Но неудобно. Мы разбиваем их на файлы по сущностям:
* миксин - в отдельный файл с именем миксина
* вью - в отдельный файл с именем вью
...
### Доделки:
1. Отдать крестики.
2. Дать ссылку на ветку с полностью сверстанным инпутом.
