...
Первый шаг мы сделали [здесь](new-page.md) — мы создали страницу `test-page.page.js`.
...
Если такой страницы у вас нет, [создайте](new-page.md) её прямо сейчас и возвращатесь сюда :)

# Как создать новый блок

Будем создавать несложный блок. Например, `input`.

Сразу позовём его из страницы и обновим браузер:
...
Успех? В браузере появился блок, хотя мы его даже не создавали?
