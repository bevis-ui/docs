...
А в конструкторе один из методов вызовем, чтобы убедиться, что наша программа работает :)
...
браузера, это даёт разработчику полный контроль. Решение о том, нужно ли инициализировать все блоки сразу во время
загрузки страницы (или только какие-то блоки "по мере их готовности") принимаете вы — разработчик проекта.

Если вы хотите, чтобы бивис инициализировал все блоки на странице автоматически во время загрузки страницы (а вы
именно этого сейчас и хотите), вам нужно указать дополнительную зависимость для страницы.
