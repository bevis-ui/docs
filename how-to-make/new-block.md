...
_Скорее всего вы не проектируете свои приложения с помощью `UML`-схем. Честно говоря, мы бы тоже с удовольствием _не_
использовали эти схемы ;)_

_Но нам трудно без формальных схем проектировать большие приложения, поэтому мы этим и занимаемся. Если вам
будет это интересно, мы читаем про `UML` на сайте
[http://plantuml.sourceforge.net/](http://plantuml.sourceforge.net/), а красивые картинки генерим здесь:
[http://www.plantuml.com/plantuml/form](http://www.plantuml.com/plantuml/form)_

----

Что мы поняли, когда составили `UML`-схемы?
