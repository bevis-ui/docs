...
А потому что по дефолту в Бивисе отключена автоматическая инициализация всех блоков. Это экономно расходует память
...
именно этого в данном примере хотите), вам нужно указать дополнительную зависимость для страницы.
