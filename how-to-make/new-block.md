...
Если такой страницы у вас нет, [создайте](new-page.md) её прямо сейчас и возвращатесь.

# Как создать новый блок

Будем создавать несложный блок. Например, `input`. Сразу позовём его из страницы и обновим браузер:
