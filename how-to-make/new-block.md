...
В документе про CSS мы расскажем:
...
В документе про JS мы расскажем:
* про способы инициализирации блока
* про доступ и операции над элементами блока
* про навешивание событий на блок и элементы

В документе про BT мы расскажем:
