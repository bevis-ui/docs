...
В консоли прервём приложение сочетанием клавиш `Ctrl-C` и воспользуемся инструментом для создания нового блока. Это небольшой bash-скрипт, который задаст вам один
...
[Ymaps Modules](how-to-make/modules.md), которые придумали и разработали
